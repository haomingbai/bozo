...
#include <bozo/detail/asio_compat.hpp>
 ...
 * but in BOZO this is a part of operations customization for extentions like failover.
 *
 ...
 * ###Customization Point
 *
 * The function is implemented via `bozo::get_operation_initiator_impl`. The default
 * implementation is:
@code
template <typename Operation>
struct get_operation_initiator_impl {
