...
BOZO_STRONG_TYPEDEF(std::vector<char>, bytes)
...
#define BOZO_STRONG_TYPEDEF(base, type)
#else
#define BOZO_STRONG_TYPEDEF(base, type)\
    using type = bozo::strong_typedef_wrapper<base, class type##_strong_typedef_tag>;
#endif
