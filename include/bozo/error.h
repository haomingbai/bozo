...
/**
 * @brief BOZO related error codes
 *
 * Enumeration of error codes provided by the BOZO library. Mainly it contains errors related
...
/**
 * @brief BOZO related errors category
 *
 * BOZO related errors category object is used to construct error_code.
 *
 ...
 *
 * This useful error conditions incorporate bozo, libpq and Boost.Asio error codes.
 *
...
enum code {
    ...
    connection_error, //!< connection-related error condition, incorporates bozo, libpq and Boost.Asio connection errors
...
template <>
struct is_error_code_enum<bozo::error::code> : std::true_type {};

template <>
struct is_error_condition_enum<bozo::sqlstate::code> : std::true_type {};

template <>
struct is_error_condition_enum<bozo::errc::code> : std::true_type {};
...
public:
    const char* name() const noexcept override final { return "bozo::error::category"; }
...
class category final : public error_category {
public:
    const char* name() const noexcept override final { return "bozo::sqlstate::category"; }

    std::string message(int value) const override final {
        #define BOZO_SQLSTATE_NAME(value) case value: return std::string(#value) + "(" + detail::ltob36(value) + ")";
        switch (value) {
            BOZO_SQLSTATE_NAME(successful_completion)
            BOZO_SQLSTATE_NAME(warning)
            BOZO_SQLSTATE_NAME(dynamic_result_sets_returned)
            BOZO_SQLSTATE_NAME(implicit_zero_bit_padding)
            BOZO_SQLSTATE_NAME(null_value_eliminated_in_set_function)
            BOZO_SQLSTATE_NAME(privilege_not_granted)
            BOZO_SQLSTATE_NAME(privilege_not_revoked)
            BOZO_SQLSTATE_NAME(string_data_right_truncation_warning)
            BOZO_SQLSTATE_NAME(deprecated_feature)
            BOZO_SQLSTATE_NAME(no_data)
            BOZO_SQLSTATE_NAME(no_additional_dynamic_result_sets_returned)
            BOZO_SQLSTATE_NAME(sql_statement_not_yet_complete)
            BOZO_SQLSTATE_NAME(connection_exception)
            BOZO_SQLSTATE_NAME(connection_does_not_exist)
            BOZO_SQLSTATE_NAME(connection_failure)
            BOZO_SQLSTATE_NAME(sqlclient_unable_to_establish_sqlconnection)
            BOZO_SQLSTATE_NAME(sqlserver_rejected_establishment_of_sqlconnection)
            BOZO_SQLSTATE_NAME(transaction_resolution_unknown)
            BOZO_SQLSTATE_NAME(protocol_violation)
            BOZO_SQLSTATE_NAME(triggered_action_exception)
            BOZO_SQLSTATE_NAME(feature_not_supported)
            BOZO_SQLSTATE_NAME(invalid_transaction_initiation)
            BOZO_SQLSTATE_NAME(locator_exception)
            BOZO_SQLSTATE_NAME(invalid_locator_specification)
            BOZO_SQLSTATE_NAME(invalid_grantor)
            BOZO_SQLSTATE_NAME(invalid_grant_operation)
            BOZO_SQLSTATE_NAME(invalid_role_specification)
            BOZO_SQLSTATE_NAME(diagnostics_exception)
            BOZO_SQLSTATE_NAME(stacked_diagnostics_accessed_without_active_handler)
            BOZO_SQLSTATE_NAME(case_not_found)
            BOZO_SQLSTATE_NAME(cardinality_violation)
            BOZO_SQLSTATE_NAME(data_exception)
            BOZO_SQLSTATE_NAME(array_subscript_error)
            BOZO_SQLSTATE_NAME(character_not_in_repertoire)
            BOZO_SQLSTATE_NAME(datetime_field_overflow)
            BOZO_SQLSTATE_NAME(division_by_zero)
            BOZO_SQLSTATE_NAME(error_in_assignment)
            BOZO_SQLSTATE_NAME(escape_character_conflict)
            BOZO_SQLSTATE_NAME(indicator_overflow)
            BOZO_SQLSTATE_NAME(interval_field_overflow)
            BOZO_SQLSTATE_NAME(invalid_argument_for_logarithm)
            BOZO_SQLSTATE_NAME(invalid_argument_for_ntile_function)
            BOZO_SQLSTATE_NAME(invalid_argument_for_nth_value_function)
            BOZO_SQLSTATE_NAME(invalid_argument_for_power_function)
            BOZO_SQLSTATE_NAME(invalid_argument_for_width_bucket_function)
            BOZO_SQLSTATE_NAME(invalid_character_value_for_cast)
            BOZO_SQLSTATE_NAME(invalid_datetime_format)
            BOZO_SQLSTATE_NAME(invalid_escape_character)
            BOZO_SQLSTATE_NAME(invalid_escape_octet)
            BOZO_SQLSTATE_NAME(invalid_escape_sequence)
            BOZO_SQLSTATE_NAME(nonstandard_use_of_escape_character)
            BOZO_SQLSTATE_NAME(invalid_indicator_parameter_value)
            BOZO_SQLSTATE_NAME(invalid_parameter_value)
            BOZO_SQLSTATE_NAME(invalid_regular_expression)
            BOZO_SQLSTATE_NAME(invalid_row_count_in_limit_clause)
            BOZO_SQLSTATE_NAME(invalid_row_count_in_result_offset_clause)
            BOZO_SQLSTATE_NAME(invalid_time_zone_displacement_value)
            BOZO_SQLSTATE_NAME(invalid_use_of_escape_character)
            BOZO_SQLSTATE_NAME(most_specific_type_mismatch)
            BOZO_SQLSTATE_NAME(null_value_not_allowed)
            BOZO_SQLSTATE_NAME(null_value_no_indicator_parameter)
            BOZO_SQLSTATE_NAME(numeric_value_out_of_range)
            BOZO_SQLSTATE_NAME(string_data_length_mismatch)
            BOZO_SQLSTATE_NAME(string_data_right_truncation)
            BOZO_SQLSTATE_NAME(substring_error)
            BOZO_SQLSTATE_NAME(trim_error)
            BOZO_SQLSTATE_NAME(unterminated_c_string)
            BOZO_SQLSTATE_NAME(zero_length_character_string)
            BOZO_SQLSTATE_NAME(floating_point_exception)
            BOZO_SQLSTATE_NAME(invalid_text_representation)
            BOZO_SQLSTATE_NAME(invalid_binary_representation)
            BOZO_SQLSTATE_NAME(bad_copy_file_format)
            BOZO_SQLSTATE_NAME(untranslatable_character)
            BOZO_SQLSTATE_NAME(not_an_xml_document)
            BOZO_SQLSTATE_NAME(invalid_xml_document)
            BOZO_SQLSTATE_NAME(invalid_xml_content)
            BOZO_SQLSTATE_NAME(invalid_xml_comment)
            BOZO_SQLSTATE_NAME(invalid_xml_processing_instruction)
            BOZO_SQLSTATE_NAME(integrity_constraint_violation)
            BOZO_SQLSTATE_NAME(restrict_violation)
            BOZO_SQLSTATE_NAME(not_null_violation)
            BOZO_SQLSTATE_NAME(foreign_key_violation)
            BOZO_SQLSTATE_NAME(unique_violation)
            BOZO_SQLSTATE_NAME(check_violation)
            BOZO_SQLSTATE_NAME(exclusion_violation)
            BOZO_SQLSTATE_NAME(invalid_cursor_state)
            BOZO_SQLSTATE_NAME(invalid_transaction_state)
            BOZO_SQLSTATE_NAME(active_sql_transaction)
            BOZO_SQLSTATE_NAME(branch_transaction_already_active)
            BOZO_SQLSTATE_NAME(held_cursor_requires_same_isolation_level)
            BOZO_SQLSTATE_NAME(inappropriate_access_mode_for_branch_transaction)
            BOZO_SQLSTATE_NAME(inappropriate_isolation_level_for_branch_transaction)
            BOZO_SQLSTATE_NAME(no_active_sql_transaction_for_branch_transaction)
            BOZO_SQLSTATE_NAME(read_only_sql_transaction)
            BOZO_SQLSTATE_NAME(schema_and_data_statement_mixing_not_supported)
            BOZO_SQLSTATE_NAME(no_active_sql_transaction)
            BOZO_SQLSTATE_NAME(in_failed_sql_transaction)
            BOZO_SQLSTATE_NAME(invalid_sql_statement_name)
            BOZO_SQLSTATE_NAME(triggered_data_change_violation)
            BOZO_SQLSTATE_NAME(invalid_authorization_specification)
            BOZO_SQLSTATE_NAME(invalid_password)
            BOZO_SQLSTATE_NAME(dependent_privilege_descriptors_still_exist)
            BOZO_SQLSTATE_NAME(dependent_objects_still_exist)
            BOZO_SQLSTATE_NAME(invalid_transaction_termination)
            BOZO_SQLSTATE_NAME(sql_routine_exception)
            BOZO_SQLSTATE_NAME(function_executed_no_return_statement)
            BOZO_SQLSTATE_NAME(modifying_sql_data_not_permitted)
            BOZO_SQLSTATE_NAME(prohibited_sql_statement_attempted)
            BOZO_SQLSTATE_NAME(reading_sql_data_not_permitted)
            BOZO_SQLSTATE_NAME(invalid_cursor_name)
            BOZO_SQLSTATE_NAME(external_routine_exception)
            BOZO_SQLSTATE_NAME(containing_sql_not_permitted)
            BOZO_SQLSTATE_NAME(modifying_sql_data_not_permitted_external)
            BOZO_SQLSTATE_NAME(prohibited_sql_statement_attempted_external)
            BOZO_SQLSTATE_NAME(reading_sql_data_not_permitted_external)
            BOZO_SQLSTATE_NAME(external_routine_invocation_exception)
            BOZO_SQLSTATE_NAME(invalid_sqlstate_returned)
            BOZO_SQLSTATE_NAME(null_value_not_allowed_external)
            BOZO_SQLSTATE_NAME(trigger_protocol_violated)
            BOZO_SQLSTATE_NAME(srf_protocol_violated)
            BOZO_SQLSTATE_NAME(savepoint_exception)
            BOZO_SQLSTATE_NAME(invalid_savepoint_specification)
            BOZO_SQLSTATE_NAME(invalid_catalog_name)
            BOZO_SQLSTATE_NAME(invalid_schema_name)
            BOZO_SQLSTATE_NAME(transaction_rollback)
            BOZO_SQLSTATE_NAME(transaction_integrity_constraint_violation)
            BOZO_SQLSTATE_NAME(serialization_failure)
            BOZO_SQLSTATE_NAME(statement_completion_unknown)
            BOZO_SQLSTATE_NAME(deadlock_detected)
            BOZO_SQLSTATE_NAME(syntax_error_or_access_rule_violation)
            BOZO_SQLSTATE_NAME(syntax_error)
            BOZO_SQLSTATE_NAME(insufficient_privilege)
            BOZO_SQLSTATE_NAME(cannot_coerce)
            BOZO_SQLSTATE_NAME(grouping_error)
            BOZO_SQLSTATE_NAME(windowing_error)
            BOZO_SQLSTATE_NAME(invalid_recursion)
            BOZO_SQLSTATE_NAME(invalid_foreign_key)
            BOZO_SQLSTATE_NAME(invalid_name)
            BOZO_SQLSTATE_NAME(name_too_long)
            BOZO_SQLSTATE_NAME(reserved_name)
            BOZO_SQLSTATE_NAME(datatype_mismatch)
            BOZO_SQLSTATE_NAME(indeterminate_datatype)
            BOZO_SQLSTATE_NAME(collation_mismatch)
            BOZO_SQLSTATE_NAME(indeterminate_collation)
            BOZO_SQLSTATE_NAME(wrong_object_type)
            BOZO_SQLSTATE_NAME(undefined_column)
            BOZO_SQLSTATE_NAME(undefined_function)
            BOZO_SQLSTATE_NAME(undefined_table)
            BOZO_SQLSTATE_NAME(undefined_parameter)
            BOZO_SQLSTATE_NAME(undefined_object)
            BOZO_SQLSTATE_NAME(duplicate_column)
            BOZO_SQLSTATE_NAME(duplicate_cursor)
            BOZO_SQLSTATE_NAME(duplicate_database)
            BOZO_SQLSTATE_NAME(duplicate_function)
            BOZO_SQLSTATE_NAME(duplicate_prepared_statement)
            BOZO_SQLSTATE_NAME(duplicate_schema)
            BOZO_SQLSTATE_NAME(duplicate_table)
            BOZO_SQLSTATE_NAME(duplicate_alias)
            BOZO_SQLSTATE_NAME(duplicate_object)
            BOZO_SQLSTATE_NAME(ambiguous_column)
            BOZO_SQLSTATE_NAME(ambiguous_function)
            BOZO_SQLSTATE_NAME(ambiguous_parameter)
            BOZO_SQLSTATE_NAME(ambiguous_alias)
            BOZO_SQLSTATE_NAME(invalid_column_reference)
            BOZO_SQLSTATE_NAME(invalid_column_definition)
            BOZO_SQLSTATE_NAME(invalid_cursor_definition)
            BOZO_SQLSTATE_NAME(invalid_database_definition)
            BOZO_SQLSTATE_NAME(invalid_function_definition)
            BOZO_SQLSTATE_NAME(invalid_prepared_statement_definition)
            BOZO_SQLSTATE_NAME(invalid_schema_definition)
            BOZO_SQLSTATE_NAME(invalid_table_definition)
            BOZO_SQLSTATE_NAME(invalid_object_definition)
            BOZO_SQLSTATE_NAME(with_check_option_violation)
            BOZO_SQLSTATE_NAME(insufficient_resources)
            BOZO_SQLSTATE_NAME(disk_full)
            BOZO_SQLSTATE_NAME(out_of_memory)
            BOZO_SQLSTATE_NAME(too_many_connections)
            BOZO_SQLSTATE_NAME(configuration_limit_exceeded)
            BOZO_SQLSTATE_NAME(program_limit_exceeded)
            BOZO_SQLSTATE_NAME(statement_too_complex)
            BOZO_SQLSTATE_NAME(too_many_columns)
            BOZO_SQLSTATE_NAME(too_many_arguments)
            BOZO_SQLSTATE_NAME(object_not_in_prerequisite_state)
            BOZO_SQLSTATE_NAME(object_in_use)
            BOZO_SQLSTATE_NAME(cant_change_runtime_param)
            BOZO_SQLSTATE_NAME(lock_not_available)
            BOZO_SQLSTATE_NAME(operator_intervention)
            BOZO_SQLSTATE_NAME(query_canceled)
            BOZO_SQLSTATE_NAME(admin_shutdown)
            BOZO_SQLSTATE_NAME(crash_shutdown)
            BOZO_SQLSTATE_NAME(cannot_connect_now)
            BOZO_SQLSTATE_NAME(database_dropped)
            BOZO_SQLSTATE_NAME(system_error)
            BOZO_SQLSTATE_NAME(io_error)
            BOZO_SQLSTATE_NAME(undefined_file)
            BOZO_SQLSTATE_NAME(duplicate_file)
            BOZO_SQLSTATE_NAME(config_file_error)
            BOZO_SQLSTATE_NAME(lock_file_exists)
            BOZO_SQLSTATE_NAME(fdw_error)
            BOZO_SQLSTATE_NAME(fdw_column_name_not_found)
            BOZO_SQLSTATE_NAME(fdw_dynamic_parameter_value_needed)
            BOZO_SQLSTATE_NAME(fdw_function_sequence_error)
            BOZO_SQLSTATE_NAME(fdw_inconsistent_descriptor_information)
            BOZO_SQLSTATE_NAME(fdw_invalid_attribute_value)
            BOZO_SQLSTATE_NAME(fdw_invalid_column_name)
            BOZO_SQLSTATE_NAME(fdw_invalid_column_number)
            BOZO_SQLSTATE_NAME(fdw_invalid_data_type)
            BOZO_SQLSTATE_NAME(fdw_invalid_data_type_descriptors)
            BOZO_SQLSTATE_NAME(fdw_invalid_descriptor_field_identifier)
            BOZO_SQLSTATE_NAME(fdw_invalid_handle)
            BOZO_SQLSTATE_NAME(fdw_invalid_option_index)
            BOZO_SQLSTATE_NAME(fdw_invalid_option_name)
            BOZO_SQLSTATE_NAME(fdw_invalid_string_length_or_buffer_length)
            BOZO_SQLSTATE_NAME(fdw_invalid_string_format)
            BOZO_SQLSTATE_NAME(fdw_invalid_use_of_null_pointer)
            BOZO_SQLSTATE_NAME(fdw_too_many_handles)
            BOZO_SQLSTATE_NAME(fdw_out_of_memory)
            BOZO_SQLSTATE_NAME(fdw_no_schemas)
            BOZO_SQLSTATE_NAME(fdw_option_name_not_found)
            BOZO_SQLSTATE_NAME(fdw_reply_handle)
            BOZO_SQLSTATE_NAME(fdw_schema_not_found)
            BOZO_SQLSTATE_NAME(fdw_table_not_found)
            BOZO_SQLSTATE_NAME(fdw_unable_to_create_execution)
            BOZO_SQLSTATE_NAME(fdw_unable_to_create_reply)
            BOZO_SQLSTATE_NAME(fdw_unable_to_establish_connection)
            BOZO_SQLSTATE_NAME(plpgsql_error)
            BOZO_SQLSTATE_NAME(raise_exception)
            BOZO_SQLSTATE_NAME(no_data_found)
            BOZO_SQLSTATE_NAME(too_many_rows)
            BOZO_SQLSTATE_NAME(internal_error)
            BOZO_SQLSTATE_NAME(data_corrupted)
            BOZO_SQLSTATE_NAME(index_corrupted)
        }
    #undef BOZO_SQLSTATE_NAME
...
#define BOZO_SQL_STATE_CONDITION(name) case name: return value_in(name)
            switch(condition) {
                BOZO_SQL_STATE_CONDITION(warning);
                BOZO_SQL_STATE_CONDITION(no_data);
                BOZO_SQL_STATE_CONDITION(sql_statement_not_yet_complete);
                BOZO_SQL_STATE_CONDITION(connection_exception);
                BOZO_SQL_STATE_CONDITION(triggered_action_exception);
                BOZO_SQL_STATE_CONDITION(feature_not_supported);
                BOZO_SQL_STATE_CONDITION(invalid_transaction_initiation);
                BOZO_SQL_STATE_CONDITION(locator_exception);
                BOZO_SQL_STATE_CONDITION(invalid_grantor);
                BOZO_SQL_STATE_CONDITION(invalid_role_specification);
                BOZO_SQL_STATE_CONDITION(diagnostics_exception);
                BOZO_SQL_STATE_CONDITION(case_not_found);
                BOZO_SQL_STATE_CONDITION(cardinality_violation);
                BOZO_SQL_STATE_CONDITION(data_exception);
                BOZO_SQL_STATE_CONDITION(integrity_constraint_violation);
                BOZO_SQL_STATE_CONDITION(invalid_cursor_state);
                BOZO_SQL_STATE_CONDITION(invalid_transaction_state);
                BOZO_SQL_STATE_CONDITION(invalid_sql_statement_name);
                BOZO_SQL_STATE_CONDITION(triggered_data_change_violation);
                BOZO_SQL_STATE_CONDITION(invalid_authorization_specification);
                BOZO_SQL_STATE_CONDITION(dependent_privilege_descriptors_still_exist);
                BOZO_SQL_STATE_CONDITION(invalid_transaction_termination);
                BOZO_SQL_STATE_CONDITION(sql_routine_exception);
                BOZO_SQL_STATE_CONDITION(invalid_cursor_name);
                BOZO_SQL_STATE_CONDITION(external_routine_exception);
                BOZO_SQL_STATE_CONDITION(external_routine_invocation_exception);
                BOZO_SQL_STATE_CONDITION(savepoint_exception);
                BOZO_SQL_STATE_CONDITION(invalid_catalog_name);
                BOZO_SQL_STATE_CONDITION(invalid_schema_name);
                BOZO_SQL_STATE_CONDITION(transaction_rollback);
                BOZO_SQL_STATE_CONDITION(syntax_error_or_access_rule_violation);
                BOZO_SQL_STATE_CONDITION(with_check_option_violation);
                BOZO_SQL_STATE_CONDITION(insufficient_resources);
                BOZO_SQL_STATE_CONDITION(program_limit_exceeded);
                BOZO_SQL_STATE_CONDITION(object_not_in_prerequisite_state);
                BOZO_SQL_STATE_CONDITION(operator_intervention);
                BOZO_SQL_STATE_CONDITION(system_error);
                BOZO_SQL_STATE_CONDITION(snapshot_too_old);
                BOZO_SQL_STATE_CONDITION(config_file_error);
                BOZO_SQL_STATE_CONDITION(fdw_error);
                BOZO_SQL_STATE_CONDITION(plpgsql_error);
                BOZO_SQL_STATE_CONDITION(internal_error);
            }
        }
        return error_category::equivalent(code, condition);
#undef BOZO_SQL_STATE_CONDITION
    }
};
...
struct codes_for_condition<connection_error> {
    constexpr static auto value = hana::make_tuple(
        // SQL state
        bozo::sqlstate::connection_exception,
        // Asio errors
        ...
        // BOZO libpq-related errors
        bozo::error::pq_connection_start_failed,
        bozo::error::pq_socket_failed,
        bozo::error::pq_connection_status_bad,
        bozo::error::pq_connect_poll_failed,
        bozo::error::pg_send_query_params_failed,
        bozo::error::pg_consume_input_failed,
        bozo::error::pg_set_nonblocking_failed,
        bozo::error::pg_flush_failed
    );
};

template <>
struct codes_for_condition<database_readonly> {
    constexpr static auto value = hana::make_tuple(bozo::sqlstate::read_only_sql_transaction);
};

template <>
struct codes_for_condition<introspection_error> {
    constexpr static auto value = hana::make_tuple(
        bozo::error::bad_result_process,
        bozo::error::bad_object_size,
        bozo::error::bad_array_size,
        bozo::error::bad_array_dimension,
        bozo::error::bad_composite_size,
        bozo::error::unexpected_eof
    );
};

template <>
struct codes_for_condition<type_mismatch> {
    constexpr static auto value = hana::make_tuple(bozo::error::oid_type_mismatch);
};

template <>
struct codes_for_condition<protocol_error> {
    constexpr static auto value = hana::make_tuple(
        bozo::error::no_sql_state_found,
        bozo::error::result_status_unexpected,
        bozo::error::result_status_empty_query,
        bozo::error::result_status_bad_response,
        bozo::error::oid_request_failed
    );
};

template<code Code>
constexpr bool match_code(const error_code& ec) {
    return bozo::errc::match_code(codes_for_condition<Code>::value, ec);
}

class category final : public error_category {
public:
    const char* name() const noexcept override final { return "bozo::errc::category"; }
    ...
    bool equivalent (const error_code& code, int condition) const noexcept override final {
#define BOZO_ERRC_CONDITION_MATCH(name) case name: return match_code<name>(code);
        switch (condition) {
            case ok : return code == error_code{};
            BOZO_ERRC_CONDITION_MATCH(connection_error);
            BOZO_ERRC_CONDITION_MATCH(database_readonly);
            BOZO_ERRC_CONDITION_MATCH(introspection_error);
            BOZO_ERRC_CONDITION_MATCH(type_mismatch);
            BOZO_ERRC_CONDITION_MATCH(protocol_error);
        }
#undef BOZO_ERRC_CONDITION_MATCH
        return error_category::equivalent(code, condition);
    }
};
