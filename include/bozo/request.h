 ...
 * @param out --- output object like Iterator, #InsertIterator or `bozo::result`.
 ...
 *
 * This function is time constrain free shortcut to `bozo::request()` function.
 * Its call is equal to `bozo::request(provider, query, bozo::none, out, token)` call.
 *
 * @note The function does not participate in ADL since could be implemented via functional object.
 *
