 ...
 *
 * This options can be used with bozo::begin
 */
struct transaction_options {
    constexpr static option<class isolation_level_tag> isolation_level{}; //!< Transaction isolation level, see bozo::isolation_level
    constexpr static option<class mode_tag> mode{}; //!< Transaction mode, see bozo::transaction_mode
    constexpr static option<class deferrability_tag> deferrability{}; //!< Transaction deferrability, see bozo::deferrable_mode
};
