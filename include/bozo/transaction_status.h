 ...
 * can be reused only with `bozo::transaction_status::idle` status, in case of the other status
 ...
 * #Nullable in null-state returns `bozo::transaction_status::unknown`. In other
...
#include <bozo/impl/transaction_status.h>
